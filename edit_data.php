         ...
         ?>
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input class="form-control" type="text" name="nama_barang" value="<?php echo $nama_barang; ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Gambar Barang * : </label>
              <div class="col-sm-10"><input type="file" name="gambar_barang" required><?php echo "<img src='barang/$gambar_barang' width='125px'>"; ?></div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Harga Barang* : </label>
              <div class="col-sm-10"><input class="form-control" type="number" name="harga" value="<?php echo $harga; ?>"required></div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Stok Barang * : </label>
              <div class="col-sm-10"><input class="form-control" type="number" name="stok" value="<?php echo $stok; ?>"required></div>
            </div>
            <div class="form-group">
              <div class="control">
                <center>
          ...
          <?php 
            ...
            if (isset($_POST['edit'])) {
              ...
              $query = "UPDATE barang SET nama_barang='$nama_barang',gambar_barang='$gambar_barang',harga='$harga',stok='$stok' WHERE id_barang='$id_barang'";
              
              if (mysqli_query($koneksi, $query)) {
                echo "<h2>Edit Data Berhasil</h2>";
